...
/**
 * Menggabungkan /senzy dengan command plugin lain bernama "SenzyXPRLoot" (sistem XPR Boost
 ...
 * Argumen pertama yang cocok dengan subcommand SenzyShop (shop, shop-search, balance, sell,
 * sellall, contract, restock, admin) ditangani oleh SenzyShop. Semua argumen lain (mis. xpr,
 * lootbox, reload, help) diteruskan apa adanya ke executor/tab-completer ASLI, jadi perilaku
 * plugin lain itu tidak berubah sedikit pun.
 */
public final class CommandBridge implements CommandExecutor, TabCompleter {
    private static final Set<String> SHOP_KEYWORDS = Set.of(
            "shop", "shop-search", "balance", "bal", "sell", "sellall", "contract", "restock", "admin");
